...
#include <ctype.h>
char *
get_work_directory (void)	//get current working directory
{
...
void
init_sh (void)			//initialise the myshell 
{
  chdir ("/home");
}

void
cd_fun (void)			//change working directory`
{
...
char *
read_inputline (void)		//read input lines
{
  char *line = NULL;
  ssize_t bufsize = 0;
